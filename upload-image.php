...
{
  $max_size = 700 * 700; // 500 KB
  $destination_directory = "images/studentPasportPics/";
    ...
    if ( $_FILES["file"]["size"] < ($max_size) )
    {
      ...
      else
      {
        ...
        else
        {
          ...
          $indexNu =  $_SESSION['email'] . ".jpg";


          $targetPath = $destination_directory .$indexNu ;
  ...
  {
    echo "<div class=\"alert alert-danger\" role=\"alert\">Unvalid image format. Allowed formats: JPG, JPEG.</div>";
  }
}
